...
public class StringMethods {
    ...
    public static void main(String[] args) {
        ...
        int index = ad.indexOf("f");
        System.out.println(index);

        int lindex = ad.lastIndexOf("qaz");
...
//        System.out.println(ad.substring(12));
//        System.out.println(ad.substring(7,14));
//        System.out.println(ad.replace("af","kj"));
        ...
        String name2 = "Rafael Mammadov";
        System.out.println(name2.substring(name2.indexOf(" ")));
